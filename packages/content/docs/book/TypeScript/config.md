...
<script setup>
import TSConfigCard from './TSConfigCard.vue'
</script>

<TSConfigCard title="isolatedModules" defaultVal="false">
  <template #background>
...
<TSConfigCard title="useDefineForClassFields" defaultVal="true">
  <template #background>
